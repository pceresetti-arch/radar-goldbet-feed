...
RAW = OUT / "football-data-SCO1.csv"
PROFILE = OUT / "source-profile.json"
SOURCES = [
    ("2022/2023", "https://www.football-data.co.uk/mmz4281/2223/SC0.csv"),
    ("2023/2024", "https://www.football-data.co.uk/mmz4281/2324/SC0.csv"),
    ("2024/2025", "https://www.football-data.co.uk/mmz4281/2425/SC0.csv"),
    ("2025/2026", "https://www.football-data.co.uk/mmz4281/2526/SC0.csv"),
]
...
def main():
    ...
    for season, url in SOURCES:
        try:
            ...
            if len(rows) != 228:
                raise ValueError(f"expected 228 Scottish Premiership fixtures, got {len(rows)}")
            source_path = OUT / f"football-data-SC0-{season.replace('/','-')}.csv"
    ...
    profile = {
        "schema_version": "radar-historical-scotland1-source-profile-v1",
