...
DATA = Path("feed/historical/sweden/allsvenskan-2022-2025-regular.csv")
BASELINE = Path("feed/historical/sweden/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/sweden/allsvenskan-2022-2025-features.csv")
REPORT_OUT = Path("feed/historical/sweden/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "fixed before holdout evaluation"
        },
        "feature_rules": {
