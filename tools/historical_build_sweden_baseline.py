...
RAW = Path("feed/historical/sweden/football-data-SWE.csv")
OUT = Path("feed/historical/sweden")
NORMALIZED = OUT / "allsvenskan-2022-2025-regular.csv"
...
def main():
    ...
    selected = [r for r in source if r.get("Season") in SEASONS and r.get("League") == "Allsvenskan"]
    appearances = {}
    ...
    report = {
        "schema_version": "radar-historical-sweden-baseline-v1",
        "generated_at": datetime.now(timezone.utc).isoformat(),
        "source_snapshot": str(RAW),
        "normalized_dataset": str(NORMALIZED),
        "selection_rule_frozen_before_evaluation": "Latest four completed source seasons 2022-2025; regular 16-team Allsvenskan only; cross-division playoffs excluded.",
        "seasons": SEASONS,
