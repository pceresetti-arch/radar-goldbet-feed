...
SOURCE_PAGE = "https://www.football-data.co.uk/norway.php"
...
def main():
    ...
    report={
      "schema_version":"radar-historical-norway-source-discovery-v1",
            ...
            try:
                ...
                try:
                    ...
                    if u.lower().endswith("/new/nor.csv"):
                        raw_path=OUT/"football-data-NOR.csv"
    ...
    if primary:
        profile={
          "schema_version":"radar-historical-norway-dataset-profile-v1",
          "generated_at":generated,
