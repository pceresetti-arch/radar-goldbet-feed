...
def main():
    ...
    for season,url in SOURCES:
        try:
            ...
            path=OUT/f"football-data-F1-{season.replace('/','-')}.csv"
    ...
    report={
        "schema_version":"radar-historical-france1-format-audit-v1",
