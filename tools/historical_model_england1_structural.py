...
DATA = Path("feed/historical/england1/premier-league-2022-2026-regular.csv")
BASELINE = Path("feed/historical/england1/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/england1/premier-league-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/england1/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-england1-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before England 1 holdout evaluation",
