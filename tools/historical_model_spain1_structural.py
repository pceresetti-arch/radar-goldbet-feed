...
DATA = Path("feed/historical/spain1/laliga-2022-2026-regular.csv")
BASELINE = Path("feed/historical/spain1/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/spain1/laliga-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/spain1/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-spain1-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before Spain 1 holdout evaluation",
            "specification_source": "SWEDEN_NORWAY_V1_FROZEN_NO_SPAIN1_HOLDOUT_TUNING"
        },
        "feature_rules": {
