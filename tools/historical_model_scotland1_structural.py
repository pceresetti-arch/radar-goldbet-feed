...
DATA = Path("feed/historical/scotland1/scottish-premiership-2022-2026-regular.csv")
BASELINE = Path("feed/historical/scotland1/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/scotland1/scottish-premiership-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/scotland1/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-scotland1-structural-oos-v1",
