...
DATA = Path("feed/historical/germany1/bundesliga-2022-2026-regular.csv")
BASELINE = Path("feed/historical/germany1/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/germany1/bundesliga-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/germany1/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-germany1-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before Germany 1 holdout evaluation",
            "specification_source": "SWEDEN_NORWAY_V1_FROZEN_NO_GERMANY1_HOLDOUT_TUNING"
        },
        "feature_rules": {
