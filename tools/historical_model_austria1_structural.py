...
DATA = Path("feed/historical/austria1/austrian-bundesliga-2022-2026-regular.csv")
BASELINE = Path("feed/historical/austria1/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/austria1/austrian-bundesliga-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/austria1/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-austria1-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before Austria holdout evaluation",
            "specification_source": "SWEDEN_NORWAY_V1_FROZEN_NO_AUSTRIA1_HOLDOUT_TUNING"
        },
        "feature_rules": {
