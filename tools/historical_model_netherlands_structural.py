...
DATA = Path("feed/historical/netherlands/eredivisie-2022-2026-regular.csv")
BASELINE = Path("feed/historical/netherlands/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/netherlands/eredivisie-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/netherlands/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-netherlands-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before Netherlands holdout evaluation",
