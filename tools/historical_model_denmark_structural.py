...
DATA = Path("feed/historical/denmark/superliga-2022-2026-regular.csv")
BASELINE = Path("feed/historical/denmark/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/denmark/superliga-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/denmark/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-denmark-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before Denmark holdout evaluation",
