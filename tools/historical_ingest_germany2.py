...
RAW = OUT / "football-data-DEU2.csv"
PROFILE = OUT / "source-profile.json"
SOURCES = [
    ("2022/2023", "https://www.football-data.co.uk/mmz4281/2223/D2.csv"),
    ("2023/2024", "https://www.football-data.co.uk/mmz4281/2324/D2.csv"),
    ("2024/2025", "https://www.football-data.co.uk/mmz4281/2425/D2.csv"),
    ("2025/2026", "https://www.football-data.co.uk/mmz4281/2526/D2.csv"),
]
...
def main():
    ...
    for season, url in SOURCES:
        try:
            ...
            if len(rows) != 306:
                raise ValueError(f"expected 306 2. Bundesliga fixtures, got {len(rows)}")
            source_path = OUT / f"football-data-D2-{season.replace('/','-')}.csv"
    ...
    profile = {
        "schema_version": "radar-historical-germany2-source-profile-v1",
