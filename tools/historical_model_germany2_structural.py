...
DATA = Path("feed/historical/germany2/2-bundesliga-2022-2026-regular.csv")
BASELINE = Path("feed/historical/germany2/baseline-benchmark.json")
FEATURES_OUT = Path("feed/historical/germany2/2-bundesliga-2022-2026-features.csv")
REPORT_OUT = Path("feed/historical/germany2/structural-oos-v1.json")
OUTCOMES = ["H", "D", "A"]
K_FACTOR = 20.0
...
def main():
    ...
    report = {
        "schema_version": "radar-historical-germany2-structural-oos-v1",
        ...
        "anti_hindsight": {
            ...
            "development_seasons": ["2022/2023", "2023/2024", "2024/2025"],
            "holdout_seasons": ["2025/2026"],
            "holdout_used_for_training_or_tuning": False,
            "missing_feature_imputation": "development mean only",
            "hyperparameters": "copied unchanged from Sweden/Norway v1 before Germany 2 holdout evaluation",
            "specification_source": "SWEDEN_NORWAY_V1_FROZEN_NO_GERMANY2_HOLDOUT_TUNING"
        },
        "feature_rules": {
        ...
        "paired_match_bootstrap": {
            ...
            "seed": seed,
            "unit": "match",
            "interpretation": "Diagnostic paired uncertainty on the frozen 2025/2026 holdout; single-season dependence and lack of league replication prevent operational promotion.",
