...
SOURCE_PAGE = "https://www.football-data.co.uk/netherlands.php"
...
def main():
    ...
    report={
      "schema_version":"radar-historical-netherlands-source-discovery-v1",
            ...
            try:
                ...
                try:
                    ...
                    if u.lower().endswith("/new/dnk.csv"):
                        raw_path=OUT/"football-data-NLD.csv"
    ...
    if primary:
        profile={
          "schema_version":"radar-historical-netherlands-dataset-profile-v1",
          "generated_at":generated,
